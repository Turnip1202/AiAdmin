...
public class FastAutoGeneratorTest {
    ...
    void FastAutoGenerator() {
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3308/ai_admin?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true&zeroDateTimeBehavior=convertToNull",
                        "kang", "kang")
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("menu_relationship") // 设置需要生成的表名
